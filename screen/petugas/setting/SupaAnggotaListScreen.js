      ...
      return (
        <PaperProvider theme={Theme}>
          <Appbar.Header>
            ...
            <Appbar.Content title="Anggota Supabase" />
          </Appbar.Header>
          ...
          <List.Section>
              ...
              {this.state.data && this.state.data.map((row,key) => (
                <List.Item
                  ...
                  onPress={() => this.props.navigation.navigate('SupaAnggotaUpdateScreen', {nim: row.nim})}
                />
              ))}
              {/*end loop*/}
          </List.Section>
          ...
          <Button
              mode="contained"
              icon="plus"
              onPress={() => this.props.navigation.navigate('SupaAnggotaInsertScreen')}
              style={{margin:20}}
          >
            Insert Anggota
          </Button>
